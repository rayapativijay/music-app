  ...
  <div class="modal__container">
      ...
      <form action="payment.php" method="post">
        <ul class="form-list">
          ...
          <li class="form-list__row">
            ...
            <div id="input--cc" class="creditcard-icon"  minlength="13" maxlength="16">
          ...
          <li>
            <button type="submit" name="pay" class="button">Pay Now</button>
			 <a href="mylogin.php"> <input class="button button3" type=button id="back_btn" value="Back to login"/></a>
	...
	<?php
		if(isset($_POST['pay']))
		{
			...
			{
				$query="select * from vip where username='$loginid'";
				$query_run=mysqli_query($con,$query);
					...
					{
						$query="insert into vip values('$loginid','$password')";
						$query_run=mysqli_query($con,$query);
						if($query_run)
						{

                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="dashboard.php">
                                        ...
                                        <span class="font-size-xl text-dual-primary-dark">MUSI</span><span class="font-size-xl text-primary">QUE</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
...
{               ?>
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-energy"></i><span class="sidebar-mini-hide">song language</span></a>
                                    <ul>
                                        <li>
                                            <a href="add-event-type.php">Add song lang</a>
                                        </li>
                                        <li>
                                            <a href="manage-event-type.php">Manage song lang</a>
                                        </li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-note"></i><span class="sidebar-mini-hide">Songs</span></a>
                                    <ul>
                                        <li>
                                            <a href="new-booking.php">New songs</a>
                                        </li>
                                        <li>
                                            <a href="approved-booking.php">Approved songs</a>
                                        </li>
                                        <li>
                                            <a href="cancelled-booking.php">Cancelled songs</a>
                                        </li>
                                        <li>
                                            <a href="all-booking.php">All songs</a>
                                        </li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="booking-search.php">Song Search</a>
                                        </li>

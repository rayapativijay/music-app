			 ...
			 <div class="contact-grids">
				 <div class="col-md-6 contact-left">
					 ...
					 <form method="post">
						 ...
						 <ul>
							 <li class="text-info">Song Duration(min):</li>
							 <li><select type="text" class="form-control" name="eetime" required="true">
							 	...
							 	<option value="4-5 min">4-5 min</option>
							 	<option value="5-6 min">5-6 min</option>
						 ...
						 <ul>
							 <li class="text-info">Song lang:</li>
							 <li><select type="text" class="form-control" name="eventtype" required="true" >
							 	<option value="">Choose song language</option>
							 	<?php 
...
<option value="<?php echo htmlentities($row->EventType);?>"><?php echo htmlentities($row->EventType);?></option>
 <?php } ?>
						 ...
						 <ul>
							 <li class="text-info">choose the file:</li>
							 <li><label for="myfile">:</label>
                             <p style="color:white"> <input  type="file" id="myfile" name="myfile"> </p>
							  </li>
						 </ul>
